...
#create table for pm
kable(summary_PM25, caption = "Mean Particulates (2.5mm)", col.names = c("County", "$\\mu g/m^3$"), digits = c(NA, 2))

#create table for ozone
kable(summary_Ozone, caption = "Mean Ozone", col.names =c("County", "$\\mu g/m^3$"), digits = c(NA, 2))
```
...
```{r boxplot_1, echo=FALSE, fig.cap="2018 monthly Ozone levels", fig.align = "left", fig.height=2.85}
#create theme
custom_theme <- 
...
oz2018 <- epa_data %>%
  ...
  labs(title = "Monthly Ozone concentrations (2018)",
       y = expression(paste('Concentration (μg/', m^{3}, ")")))+
  custom_theme

ggsave("Assignments/oz2018.png", plot = oz2018, width = 6, height = 3, dpi = 300)
knitr::include_graphics("oz2018.png")
```




```{r boxplot_2, echo=FALSE, fig.align = "left", fig.cap="2019 monthly Ozone levels", , fig.height=2.85}
oz2019 <- epa_data %>%
  filter(Year == 2019) %>%
  ggplot()+
  geom_boxplot(aes(x = Month, y = Ozone))+
...
ggsave("Assignments/oz2019.png", plot = oz2019, width = 6, height = 3, dpi = 300)
knitr::include_graphics("oz2019.png")
```
...
<https://github.com/rachls/EDE_Fall2024>
