...
Selecting allows us to choose certain columns (variables) in our dataset. Below selects everythings from sampledate to temperature C columns
...
#first and last find the first and last date values in the provide date datasets
