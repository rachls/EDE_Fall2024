...
knitr is a rpackage that takes a markdown document and creates an intermediate file. Then pandoc takes this and converts it into a variety of different output.
...
-   `fig.cap`: Set figure Caption. Put graphs in diff. chunks to get diff captions
