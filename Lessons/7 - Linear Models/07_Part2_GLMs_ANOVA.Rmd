...
shapiro.test(Litter.Totals$dryMass[Litter.Totals$plotID == "NIWO_040"]) #reject null, they do not follow normal distribution
shapiro.test(Litter.Totals$dryMass[Litter.Totals$plotID == "NIWO_041"])
shapiro.test(Litter.Totals$dryMass[Litter.Totals$plotID == "NIWO_046"]) #normal
...
shapiro.test(Litter.Totals$dryMass[Litter.Totals$plotID == "NIWO_057"]) #normal
...
#results: reject null i.e. the variances are not equal
